...
class DonatedDistrictForm extends ConsumerStatefulWidget {
  const DonatedDistrictForm({super.key});

  @override
  ConsumerState<DonatedDistrictForm> createState() =>
      _DonatedDistrictFormState();
}

class _DonatedDistrictFormState extends ConsumerState<DonatedDistrictForm> {
                ...
                Flexible(
                  child: DropdownSearch<District>(
                    ...
                    asyncItems: (filter) async {
                      await locationNotifier.updateDistrictSearch(filter);
                      return locationNotifier.districts;
                    },
              ...
              children: [
                ...
                CustomButton(
                  ...
                  onPressed: () {
                    ...
                    donationNotifier.addDonatedDistrict(
                      DonatedDistrict(
                        id: -1,
                        district: _selectedDistrict!,
                        donatedPeople:
